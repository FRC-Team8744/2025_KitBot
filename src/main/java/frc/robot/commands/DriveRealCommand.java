...
public class DriveRealCommand extends Command {
  ...
  public DriveRealCommand(
      DoubleSupplier xSpeed, DoubleSupplier ySpeed, DoubleSupplier zRotation, CANDriveSubsystem driveSubsystem) {
